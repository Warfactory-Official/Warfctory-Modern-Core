...
/**
 * <p>
 * Converted from {@code missile_building_multi.litematic} via {@code litematic2gtmb.py}
 ...
 * <ul>
 * <li>S = controller</li>
 * <li>A = Solid Machine Casing (steel) - hosts the hatches</li>
 * <li>B = Industrial Steam Casing (GCYM)</li>
 * <li>C = Atomic Casing (GCYM)</li>
 * <li>D = HSSE Sturdy Machine Casing</li>
 * <li>E = Galvanized Steel frame</li>
 * <li>F = Black Steel frame</li>
 * <li>G = Light Gray Metal Sheet</li>
 * </ul>
 * AISLES: 17 chars (FRONT) x 19 strings (UP) x 17 aisles (RIGHT); first string = bottom layer.
 */
public final class MissileBuildingStructure {
    ...
    public static final String[][] AISLES = {
            ...
            { "    AAAAAAAAA    ", "      CDDDC      ", "      CDDDC      ", "      CDDDC      ", "      CDDDC      ",
                    "      C   C      ", "      CDDDC      ", "      CDDDC      ", "      CDDDC      ", "      E   E      ",
                    "      E   E      ", "      E   E      ", "                 ", "                 ", "                 ",
                    "                 ", "                 ", "                 ", "                 " },
            { "   AAABBBBBAAA   ", "    DDE   EDD    ", "    DDE   EDD    ", "    DDE   EDD    ", "    DDE   EDD    ",
                    "      GGGGG      ", "    DDE   EDD    ", "    DDE   EDD    ", "    DDE   EDD    ", "      GGGGG      ",
                    "      GGGGG      ", "      E   E      ", "                 ", "                 ", "                 ",
                    "                 ", "                 ", "                 ", "                 " },
            { "  AABBBBBBBBBAA  ", "   D         D   ", "   D         D   ", "   D         D   ", "   D         D   ",
                    "    GG     GG    ", "   D         D   ", "   D         D   ", "   D         D   ", "    GG     GG    ",
                    "    GG     GG    ", "      DDDDD      ", "                 ", "                 ", "                 ",
                    "                 ", "                 ", "                 ", "                 " },
            ...
            { " AABBBBBBBBBBBAA ", "  D           D  ", "  D           D  ", "  D           D  ", "  D           D  ",
                    "   G         G   ", "  D           D  ", "  D           D  ", "  D           D  ", "   G         G   ",
                    "   G         G   ", "    DDDDDDDDD    ", "       GGG       ", "        E        ", "        E        ",
                    "        E        ", "        E        ", "       EEE       ", "       AAA       " },
            { "AABBBBBBBBBBBBBAA", " CE   AAAAA   EC ", " CE     F     EC ", " CE     F     EC ", " CE     F     EC ",
                    " CG    FFF    GC ", " CE     F     EC ", " CE     F     EC ", " CE     F     EC ", " EG           GE ",
                    " EG           GE ", " EEDDDD   DDDDEE ", "      GCCCG      ", "       DCD       ", "       DCD       ",
                    "       DCD       ", "       DCD       ", "      ECCCE      ", "      AEEEA      " },
            { "AABBBBBBBBBBBBBAA", " D    ABBBA      ", " D               ", " D               ", " D             D ",
                    "  G   F   F   G  ", " D             D ", " D             D ", " D             D ", "  G           G  ",
                    "  G           G  ", "   DDD     DDD   ", "     GC   CG     ", "      D   D      ", "      D   D      ",
                    "      D   D      ", "      D   D      ", "     EC   CE     ", "     AE   EA     " },
            { "AABBBBBBBBBBBBBAS", " D    ABEBA      ", " D    F   F      ", " D    F   F      ", " D    F   F    D ",
                    "  G   F   F   G  ", " D    F   F    D ", " D    F   F    D ", " D    F   F    D ", "  G           G  ",
                    "  G           G  ", "   DDD     DDD   ", "     GC   CG     ", "     EC   CE     ", "     EC   CE     ",
                    "     EC   CE     ", "     EC   CE     ", "     EC   CE     ", "     AE   EA     " },
            { "AABBBBBBBBBBBBBAA", " D    ABBBA      ", " D               ", " D               ", " D             D ",
                    "  G   F   F   G  ", " D             D ", " D             D ", " D             D ", "  G           G  ",
                    "  G           G  ", "   DDD     DDD   ", "     GC   CG     ", "      D   D      ", "      D   D      ",
                    "      D   D      ", "      D   D      ", "     EC   CE     ", "     AE   EA     " },
