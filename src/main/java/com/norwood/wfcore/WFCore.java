...
import com.norwood.wfcore.common.ballistics.BallisticsEvents;
import com.norwood.wfcore.common.block.WFBlockResistanceTooltip;
import com.norwood.wfcore.common.block.WFBlockResistances;
import com.norwood.wfcore.common.chat.ChatModeration;
...
import com.norwood.wfcore.common.compute.WFComputeTooltips;
import com.norwood.wfcore.common.darkness.DarknessServerHandler;
...
import com.norwood.wfcore.common.worldgen.DepositRetrofitHandler;
import com.norwood.wfcore.common.worldgen.WFFeatures;
import com.norwood.wfcore.common.worldgen.transplant.VeinBackfillCommand;
import com.norwood.wfcore.common.worldgen.transplant.VeinBackfillRunner;
...
import com.norwood.wfcore.integration.superbwarfare.DroneUpgradeBay;
import com.norwood.wfcore.integration.superbwarfare.SbwBallisticsIntegration;
import com.norwood.wfcore.integration.superbwarfare.VehicleStorageBlacklistFilter;
...
public class WFCore {
    ...
    public WFCore() {
      ...
      WFSounds.SOUNDS.register(modEventBus);
        ...
        MinecraftForge.EVENT_BUS.register(VeinBackfillCommand.INSTANCE);
        MinecraftForge.EVENT_BUS.register(VeinBackfillRunner.INSTANCE);
        MinecraftForge.EVENT_BUS.register(DepositRetrofitHandler.INSTANCE);
        MinecraftForge.EVENT_BUS.register(new WFComputeTooltips());
        MinecraftForge.EVENT_BUS.register(new WFBlockResistanceTooltip());
        MinecraftForge.EVENT_BUS.register(new WFLootEvents());
        MinecraftForge.EVENT_BUS.register(new BallisticsEvents());
        MinecraftForge.EVENT_BUS.register(DroneUpgradeBay.INSTANCE);
        MinecraftForge.EVENT_BUS.register(VehicleStorageBlacklistFilter.INSTANCE);
        MinecraftForge.EVENT_BUS.register(DiagnosticsService.INSTANCE);
        MinecraftForge.EVENT_BUS.register(ModAuditService.INSTANCE);
        MinecraftForge.EVENT_BUS.register(ClassDumpService.INSTANCE);
        MinecraftForge.EVENT_BUS.register(DarknessServerHandler.INSTANCE);
        MinecraftForge.EVENT_BUS.register(ShaderServerHandler.INSTANCE);
        MinecraftForge.EVENT_BUS.register(ChatModeration.INSTANCE);
        MinecraftForge.EVENT_BUS.register(MaintenanceService.INSTANCE);
